...
DAO.SQLDialect.prototype.escape2=function(str,dao,column,data){
	...
	while(typeof data[column+i]!="undefined"){ i++; };
...
DAO.SQLDialect.prototype.buildUpdate=function(updater,data){
	...
	var context = {
		...
		set_exp: function() { return self.sqlExp(updater._set_exp,escape,updater.dao); },
		where_exp: function() { return self.sqlExp(updater._where_exp,escape,updater.dao); },
		//For insert
		...
		value_exp: function() { return self.sqlExp(updater._value_exp,escape,updater.dao); },
		column_exp: function() { return self.sqlExp(updater._column_exp,escape,updater.dao); },
	}
...
DAO.SQLDialect.prototype.buildSelect=function(finder,data,tableAliases){
		...
		var context = {
			...
			orderBy_exp:function(){ return self.sqlExp(finder._orderBy_exp,escape,finder.dao) },
			where:function(){ 
				if(finder._where){
			...
			set_exp: function() { return self.sqlExp(finder._set_exp,escape,finder.dao); },
			where_exp: function() { return self.sqlExp(finder._where_exp,escape,finder.dao); },
			//For insert
			value: function(column){ return "?"+column+"?"; },
			values: function(){ return Object.keys(finder.values).map(function(column){ return context.value(column); }).join(", "); },
			value_exp: function() { return self.sqlExp(finder._value_exp,escape,finder.dao); },
			column_exp: function() { return self.sqlExp(finder._column_exp,escape,finder.dao); },
		}
...
DAO.SQLDialect.prototype.buildInsert=function(inserter,data){
	...
	var context = {
		...
		set_exp: function() { return self.sqlExp(inserter._set_exp,escape,inserter.dao); },
		where_exp: function() { return self.sqlExp(inserter._where_exp,escape,dao); },
		//For insert
		...
		value_exp: function() { return self.sqlExp(inserter._value_exp,escape,inserter.dao); },
		column_exp: function() { return self.sqlExp(inserter._column_exp,escape,inserter.dao); },
...
DAO.SQLDialect.prototype.buildDelete=function(deleter,data){
	...
	var context = {
		...
		set_exp: function() { return self.sqlExp(deleter._set_exp,escape,deleter.dao); },
		where_exp: function() { return self.sqlExp(deleter._set_exp,escape,deleter.dao); },
		//For insert
		...
		value_exp: function() { return self.sqlExp(deleter._value_exp,escape,deleter.dao); },
		column_exp: function() { return self.sqlExp(deleter._column_exp,escape,deleter.dao); },
	}
